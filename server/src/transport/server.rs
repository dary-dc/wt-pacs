...
mod tests {
    ...
    /// The shared uni is started at session accept, so it arrives without a control bidi.
    /// `docs/improvements/2026-09-10.md`.
    #[test]
    fn shared_uni_arrives_before_the_client_opens_control() {
        ...
        rt.block_on(async move {
            ...
            tokio::time::timeout(Duration::from_secs(5), connection.accept_uni())
                .await
                .expect("media uni waited for the control bidi")
