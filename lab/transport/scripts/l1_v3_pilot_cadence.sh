...
# Collects NO decision rows. Writes docs/transport/measurements/r2/l1_v3_cadence.json and .pilot.tsv.
set -euo pipefail
...
RAW_DIR="${RAW_DIR:-$ROOT/docs/transport/measurements/r2/raw/l1v3/pilot}"
OUT_TSV="${OUT_TSV:-$ROOT/docs/transport/measurements/r2/l1_s_vs_q_loss_v3.pilot.tsv}"
...
"${SCP[@]}" "$ROOT/lab/transport/scripts/l1_veth_setup.sh" "$ROOT/lab/transport/scripts/l1_veth_netem.sh" \
...
doc = {
    ...
    "reader_model": {
        ...
        "factor": 0.9,
        "doc": "docs/transport/lanes/L1-v3-phase-b-regime-reader.md",
    },
    "regime_doc": "docs/transport/lanes/L1-v3-phase-b-regime-reader.md",
    "review_doc": "docs/transport/lanes/L1-v3-complete-plan.md",
    "cells": cells,
}
