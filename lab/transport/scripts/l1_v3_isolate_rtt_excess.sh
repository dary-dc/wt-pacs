...
RAW_DIR="${RAW_DIR:-$ROOT/docs/transport/measurements/r2/raw/l1v3/isolate}"
OUT_TSV="${OUT_TSV:-$ROOT/docs/transport/measurements/r2/l1_s_vs_q_loss_v3.isolate.tsv}"
OUT_MD="${OUT_MD:-$ROOT/docs/transport/measurements/r2/raw/l1v3/ISOLATION_RTT_EXCESS.md}"
