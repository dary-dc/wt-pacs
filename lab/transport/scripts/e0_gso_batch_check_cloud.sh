...
# The qdisc accounting this rests on: docs/transport/measurements/r6/r6cloud-results.md 3.2.
# Usage: LOSS=1.0 lab/transport/scripts/e0_gso_batch_check_cloud.sh
set -euo pipefail
