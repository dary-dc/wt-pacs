...
`docs/transport/measurements/r2/L1_V3_PHASE_C_REVIEW.md`. Nothing here needs the rig:
the small-collect TSV and the per-run `wait_ms` vectors are both tracked.

    python3 lab/transport/scripts/l1_v3_phase_c_review.py
...
TSV = ROOT / "docs/transport/measurements/r2/l1_s_vs_q_loss_v3.small.tsv"
RAW = ROOT / "docs/transport/measurements/r2/raw/l1v3/small"
