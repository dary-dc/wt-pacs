...
async function main() {
  ...
  const module = await globalThis.Module({
    locateFile: (f) => "/lab/decode-bench/vendor/openjph/" + f,
  });
  ...
  globalThis.__d6 = { set, loadMs: +loadMs.toFixed(1), warmup, per };
