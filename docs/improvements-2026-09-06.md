...
are in git history at commits `dbe5260` and `dc141e4` and are regenerated by the drivers in
`lab/scripts/` and `lab/bench/` (see `lab/README.md`). Nothing under `docs/` is data.
