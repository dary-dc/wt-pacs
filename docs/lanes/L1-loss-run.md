...
TSV: on tag `archive/transport-lab-2026-09` as `docs/transport/measurements/r2/l1_s_vs_q_loss_v2.tsv`
...
`lab/transport/scripts/l1_loss_run_v2_cloud.sh` (on tag `archive/transport-lab-2026-09`)
