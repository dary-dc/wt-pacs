...
[`lab/transport/scripts/quic_opt_bench.sh`](../../lab/transport/scripts/quic_opt_bench.sh) (unshaped),
[`lab/transport/scripts/quic_opt_shaped.sh`](../../lab/transport/scripts/quic_opt_shaped.sh) (rate-shaped),
[`lab/transport/aead-bench`](../../lab/transport/aead-bench) (cipher microbench).
...
[`lab/transport/scripts/gso_cap_experiment.sh`](../../lab/transport/scripts/gso_cap_experiment.sh) does it
...
Reproduce with [`lab/transport/scripts/gso_cap_experiment.sh`](../../lab/transport/scripts/gso_cap_experiment.sh),
...
`lab/transport/aead-bench` measures the seal alone, at QUIC datagram sizes, on this CPU
...
SRV_FLAGS="--send-path chunked" bash lab/transport/scripts/quic_opt_bench.sh chunked target/release/exact-server frames_250k 16 3

# multi-client — the rig to use for any server-side arm
SRV_FLAGS="--send-path chunked" bash lab/transport/scripts/quic_opt_multiclient.sh chunked target/release/exact-server 4

# rate-shaped (needs iproute2; runs in a private netns; tbf only, no netem)
RATE=1600mbit SRV_FLAGS="--send-path chunked" bash lab/transport/scripts/quic_opt_shaped.sh chunked target/release/exact-server frames_250k 16 3

# GSO segment cap — patches quinn outside the tree, leaves nothing behind
bash lab/transport/scripts/gso_cap_experiment.sh 10 32 44
SRV_FLAGS="--send-path chunked" bash lab/transport/scripts/quic_opt_multiclient.sh seg32 target/gso-arms/exact-server-32 4
