...
**Still owed.** `lab/transport/scripts/stall_client_campaign.sh` — the only instrument that can see a
...
```bash
lab/transport/scripts/stall_client_campaign.sh      # chunked arm; expect ~200 kB/connection
```
