...
**Collect runner:** `lab/transport/scripts/l1_v3_collect_small.sh`
...
Cadence from `docs/transport/measurements/r2/l1_v3_cadence.json` (clinical_under_delivery ×0.9).  
...
L1_FIX_FC=160 CELLS='60:0:4 60:0.5:4 60:2:4' PHASE=pilot \
  bash lab/transport/scripts/l1_loss_run_v3_cloud.sh

APPROVE_SMALL_COLLECT=1 SKIP_BUILD=0 \
  bash lab/transport/scripts/l1_v3_collect_small.sh

# gates only:
APPROVE_SMALL_COLLECT=1 DRY_RUN=1 bash lab/transport/scripts/l1_v3_collect_small.sh
```
