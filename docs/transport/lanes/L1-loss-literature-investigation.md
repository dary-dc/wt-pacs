...
**Empirical anchor (void, for pattern only):** `docs/transport/measurements/r2/l1_s_vs_q_loss_v2.tsv`.
...
5. **Write claim cards** into the sibling doc (`docs/transport/l1-loss-literature-review.md`) — do not overwrite
   this guide
...
Into `docs/transport/l1-loss-literature-review.md`:
...
| Path | Content |
|------|---------|
| `docs/transport/measurements/r2/L1_V2_ADVERSARIAL_REVIEW.md` | **Why v2 is void — read first** |
| `docs/transport/lanes/L1-v3-work-order.md` | The replacement campaign and its gates |
| `docs/transport/lanes/L1-v3-action-plan.md` | **The work order checked against the code** — corrections, gaps, sequencing |
| `docs/lanes/L1-loss-run.md` | v2 methodology (superseded) |
| `docs/transport/measurements/r2/l1_s_vs_q_loss_v2.tsv` | v2 rows (void) |
| `docs/transport/l1-loss-literature-review.md` | **This lane's output** |
