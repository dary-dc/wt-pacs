...
**Evidence:** `docs/transport/measurements/r2/raw/l1v3/pilot/*.json` (S-arm, `--step-interval-ms 0`)
...
Heuristic implemented in `lab/transport/scripts/l1_v3_common.sh` → `l1_stamp_regime`.
