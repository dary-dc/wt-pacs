...
`docs/transport/measurements/r2/L1_V2_ADVERSARIAL_REVIEW.md`, and
...
```bash
git mv docs/transport/measurements/r2/l1_s_vs_q_loss_v2.tsv \
       docs/transport/measurements/r2/l1_s_vs_q_loss_v2.VOID.tsv
```

Then put this as the first line of the VOID file:

```
# VOID — methodology defects, see docs/transport/measurements/r2/L1_V2_ADVERSARIAL_REVIEW.md. Do not decide from this file.
```

v3 writes to a **new** file, `docs/transport/measurements/r2/l1_s_vs_q_loss_v3.tsv`. The v3 runner must
...
```bash
RAW_DIR="${RAW_DIR:-$ROOT/docs/transport/measurements/r2/raw/l1v3}"
LOG="${LOG:-$ROOT/docs/transport/measurements/r2/raw/l1v3/RUN.log}"
```
...
`lab/traces/l1_one_way_80.json`, `lab/transport/scripts/l1_loss_run_v3_cloud.sh` or `docs/lanes/` changes
...
[ ] S8   raw JSON + tc + RUN.log committed under docs/transport/measurements/r2/raw/l1v3/
