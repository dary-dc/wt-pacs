...
| --- | ---: | ---: | ---: |
| `lab/transport/scripts/stall_client_campaign.sh` | 51 | 69 | **0.74×** |
| `server/src/record/path.rs` | 105 | 153 | **0.69×** |
| `lab/transport/scripts/r6_cell_inputs.sh` | 44 | 72 | **0.61×** |
...
- **Numbers and their provenance** → `docs/transport/measurements/` (this lane); `docs/measurements/` (product / telemetry)
