...
tables live in git history (commits `dbe5260`, `dc141e4`) and are regenerated by the drivers in
`lab/scripts/` and `lab/bench/` (`lab/README.md`) — `docs/` holds no data. Nothing here is merged.
