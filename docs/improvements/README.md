...
| **Tests** | gap | product TypeScript client has no tests; a stub `WebTransport` already drives it in Node | `client/transport-ts/test/` from `lab/bench/ts_session_stub.mjs` | [Tests](2026-09-08.md#tests--gaps) |
