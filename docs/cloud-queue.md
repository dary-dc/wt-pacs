...
| 37 | **R2** — navigation to first byte on a real round trip: count, then cut | queue §Rows 30–41 | **claimed** 2026-09-19 |
| 38 | **W1** — the first ask on an idle session | queue §Rows 30–41 | ready |
| 39 | **W2** — slow-start exit, an outage, the first timeout | queue §Rows 30–41 | ready |
