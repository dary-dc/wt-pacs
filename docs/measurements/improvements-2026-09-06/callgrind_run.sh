...
set -euo pipefail
ROOT=/home/user/wt-pacs; S=/tmp/claude-0/-home-user-wt-pacs/4388fb8e-14c3-5912-8315-3076f7ec068b/scratchpad
label=$1; bin=$2; fixture=$3; mode=$4; dwell=${5:-4000}; port=${PORT:-4477}
dir=$S/work/cg-$label-$fixture-$mode; rm -rf "$dir"; mkdir -p "$dir"
...
$S/bin/head/window-harness --url https://127.0.0.1:$port/ --mode saturate --depth 4 --read-bps 0 \
