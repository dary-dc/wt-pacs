...
/// Segments per `sendmsg`: as many as fit under the kernel's 65 527-byte GSO payload at this
/// MTU (44 at 1452), never more than `MAX_TRANSMIT_SEGMENTS`. wt-pacs patch: quinn ships 10.
